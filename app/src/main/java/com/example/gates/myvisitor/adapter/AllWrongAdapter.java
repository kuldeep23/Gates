...
public class AllWrongAdapter extends RecyclerView.Adapter<AllWrongAdapter.myViewHolder>
{
    List<AllWrongModel> data;
    TextToSpeech textToSpeech;


    public AllWrongAdapter(List<AllWrongModel> data) {
        this.data = data;
    }

    @NonNull
    @Override
    public AllWrongAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerowdesign,parent,false);
        return  new AllWrongAdapter.myViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllWrongAdapter.myViewHolder holder, int position) {

        final AllWrongModel temp = data.get(position);
